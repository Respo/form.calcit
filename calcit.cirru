...
{} (:about "|Machine-generated snapshot. Do not edit directly — changes will be overwritten. Use `calcit query` to inspect and `calcit edit`/`calcit tree` to modify. Run `calcit docs agents --full` first. Manual edits must follow format and schema conventions, then run `calcit edit format`.") (:package |form)
  :entries $ {}
    :default $ {} (:description |) (:init-fn 'form.main/main!) (:mode :native) (:reload-fn 'form.main/reload!)
      :feature-policy $ {}
              ...
              let
                ...
                div
                  ...
                  comp-form (>> states :form-example) form-items ({})
                    ...
                    %{} FormOptions $ :on-cancel
                      %some $ fn () (println |cancel)
    ...
    'form.core $ %{} 'FileEntry
      :defs $ {}
        '%form-plugin $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn %form-plugin (state rendered cursor)
              %:: (impl-traits FormPlugin0 FormPluginImpl) :form state rendered cursor
          :examples $ []
          :schema $ :: 'Dynamic
        'FormPlugin0 $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defenum FormPlugin0 $ :form (:: 'Map 'Tag 'Dynamic) 'Dynamic 'List
          :examples $ []
          :schema $ :: 'EnumDef
        'FormPluginImpl $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defimpl FormPluginImpl FormPluginTrait (.get form-plugin-get) (.render form-plugin-render) (.reset form-plugin-reset)
          :examples $ []
          :schema $ :: 'Impl
        'FormPluginTrait $ %{} 'CodeEntry (:doc |)
          :code $ quote
            deftrait FormPluginTrait (.get :fn) (.render :fn) (.reset :fn)
          :examples $ []
          :schema $ :: 'Trait
        'comp-form $ %{} 'CodeEntry (:doc |)
          ...
          :schema $ :: 'Fn
            {} (:return 'Dynamic)
              :args $ [] 'Map (:: 'List 'form.schema/FormItem) (:: 'Map 'Tag 'Dynamic) 'Fn 'form.schema/FormOptions
        ...
        'form-plugin-reset $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn form-plugin-reset (self d! data)
              match self
                (:form state rendered cursor)
                  d! $ :: :states cursor
                    option:unwrap-or data $ {}
                _ $ raise |Invalid-form-plugin
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Unit)
              :args $ [] 'form.core/FormPlugin0 'Fn
    ...
    'form.schema $ %{} 'FileEntry
      :defs $ {}
        'FormItem $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct FormItem (:type 'Tag) (:name 'Tag) (:label 'String)
        ...
        'FormOption $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct FormOption (:value 'Tag) (:title 'String)
          :examples $ []
          :schema $ :: 'StructDef
        'FormOptions $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct FormOptions $ :on-cancel
              :: 'Option $ :: 'Fn
                {}
                  :args $ []
                  :return 'Unit
        ...
        'FormStates $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct FormStates (:cursor 'List)
              :data $ :: 'Option (:: 'Map 'Tag 'Dynamic)
          :examples $ []
          :schema $ :: 'StructDef
        'SelectedOption $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defstruct SelectedOption (:value 'Tag) (:display 'String)
          :examples $ []
          :schema $ :: 'StructDef
        'store $ %{} 'CodeEntry (:doc |)
          :code $ quote
